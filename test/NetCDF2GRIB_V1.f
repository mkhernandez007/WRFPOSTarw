...
C @ running: ./NetCDF2GRIB_V1 netcdfouputfile
...
C
          ...
          do k = 1, numbvar, 1
             if (var .eq. varskeep(k)) then
                ...
                if (var == 'P') then
                   ...
                   call ToGrib(numpts, modelhieght, pressure, iyy, imo,
     ...
     &                         idd, ihh, imm, var, KGDS)
                   ...
                   numptsphi = (numpts/londim)* (londim - 1)
     ...
     &                         idd, ihh, imm, var, KGDS)
                   ...
                   latdimV = latdim - 1
                   numptsphi = numpts/latdim * latdimV
                   do j = 1, numptsphi, 1
